...
void _taskModelSerialize(
  ...
  writer.writeLong(offsets[4], object.priorityIndex);
  writer.writeLong(offsets[5], object.statusIndex);
...
TaskModel _taskModelDeserialize(
  ...
  object.id = id;
  object.priorityIndex = reader.readLong(offsets[4]);
  object.statusIndex = reader.readLong(offsets[5]);
...
extension TaskModelQueryWhereSort
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhere> anyPriorityIndex() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhere> anyStatusIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension TaskModelQueryWhere
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> priorityIndexEqualTo(
      int priorityIndex) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> priorityIndexNotEqualTo(
      int priorityIndex) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> priorityIndexLessThan(
    int priorityIndex, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> priorityIndexBetween(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> statusIndexEqualTo(
      int statusIndex) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> statusIndexNotEqualTo(
      int statusIndex) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> statusIndexGreaterThan(
    int statusIndex, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> statusIndexLessThan(
    int statusIndex, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> statusIndexBetween(
...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> statusIndexEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> statusIndexLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> statusIndexBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByStatusIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'statusIndex', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByStatusIndexDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByStatusIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'statusIndex', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByStatusIndexDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'statusIndex', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByPriorityIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'priorityIndex');
    });
  }

  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByStatusIndex() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, int, QQueryOperations> priorityIndexProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'priorityIndex');
    });
  }

  QueryBuilder<TaskModel, int, QQueryOperations> statusIndexProperty() {
    return QueryBuilder.apply(this, (query) {
