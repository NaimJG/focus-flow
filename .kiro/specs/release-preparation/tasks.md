...
- [ ] 8. Create privacy-policy documents
  - [ ] 8.1 Create `docs/privacy-policy.md` with Spanish (primary) and English sections
...
- [ ] 9. Add in-app privacy-policy access
  - [ ] 9.1 Add `url_launcher` dependency to `pubspec.yaml`
    - Add `url_launcher: ^6.2.0` under dependencies
    - Run `flutter pub get`
    - File: `pubspec.yaml`
    - _Requirements: 8.3_

  - [ ] 9.2 Create `lib/core/constants/app_urls.dart` with centralized URL constant
  ...
  - [ ] 9.3 Add privacy-policy localization strings to ARB files
  ...
  - [ ] 9.4 Create `lib/features/settings/presentation/widgets/privacy_policy_section.dart`
  ...
  - [ ] 9.5 Integrate `PrivacyPolicySection` into `SettingsScreen`
  ...
  - [ ] 9.6 Add `<queries>` intent for `url_launcher` in AndroidManifest.xml
...
- [ ] 10. Checkpoint — privacy policy and URL confirmation
